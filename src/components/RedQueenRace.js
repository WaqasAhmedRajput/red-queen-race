        ...
        <div>
            <div className="wrapper">
                ...
                <div className="earth">
                    <div id="red-queen_and_alice">
                        <img
                            ...
                            src="./images/sprite_running-alice-queen_small.png"
                            srcSet="./images/sprite_running-alice-queen.png 2x"
                ...
                <div className="scenery" id="foreground1" ref={foreground1Movement.ref}>
                    <img
                        id="palm3"
                        src="./images/palm3_small.png"
                        srcSet="./images/palm3.png 2x"
                        alt=" "
                    />
                </div>
                <div className="scenery" id="foreground2" ref={foreground2Movement.ref}>
                    <img
                        id="bush"
                        src="./images/bush_small.png"
                        srcSet="./images/bush.png 2x"
                        alt=" "
                    />
                    <img
                        id="w_rook_upright"
                        src="./images/w_rook_upright_small.png"
                        srcSet="./images/w_rook_upright.png 2x"
                        alt=" "
                    />
                </div>
                <div className="scenery" id="background1" ref={background1Movement.ref}>
                    <img
                        id="r_pawn_upright"
                        src="./images/r_pawn_upright_small.png"
                        srcSet="./images/r_pawn_upright.png 2x"
                        alt=" "
                    />
                    <img
                        id="w_rook"
                        src="./images/w_rook_small.png"
                        srcSet="./images/w_rook.png 2x"
                        alt=" "
                    />
                    <img
                        id="palm1"
                        src="./images/palm1_small.png"
                        srcSet="./images/palm1.png 2x"
                        alt=" "
                    />
                </div>
                <div className="scenery" id="background2" ref={background2Movement.ref}>
                    <img
                        id="r_pawn"
                        src="./images/r_pawn_small.png"
                        srcSet="./images/r_pawn.png 2x"
                        alt=" "
                    />

                    <img
                        id="r_knight"
                        src="./images/r_knight_small.png"
                        srcSet="./images/r_knight.png 2x"
                        alt=" "
                    />
                    <img
                        id="palm2"
                        src="./images/palm2_small.png"
                        srcSet="./images/palm2.png 2x"
                        alt=" "
                    />
                </div>
            </div>
